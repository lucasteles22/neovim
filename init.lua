...
vim.keymap.set('n', '<leader>pp', ':Lazy<CR>', { desc = 'Info' })
vim.keymap.set('n', '<leader>pi', ':Lazy install<CR>', { desc = 'Install' })
vim.keymap.set('n', '<leader>pu', ':Lazy update<CR>', { desc = 'Update' })
vim.keymap.set('n', '<leader>ps', ':Lazy update<CR>', { desc = 'Sync' })
vim.keymap.set('n', '<leader>pc', ':Lazy update<CR>', { desc = 'Check' })
...
require('lazy').setup({
  ...
  require 'config.plugins.statusline', -- adds gitsigns recommend keyma
